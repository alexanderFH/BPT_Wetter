...
public class WeatherGetter {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(getCurrentWeather("1220").getCurrentTemp());
        ArrayList<Day> days = getWeatherJson("1220");
    ...
    public static ArrayList<Day> getWeatherJson(String plz) throws IOException {
        ...
        InputStream is = new URL("https://api.weather.com/v3/wx/forecast/daily/5day?postalKey=" + plz + ":AT&format=json&units=m&language=de-DE&apiKey=1531e846099f413eb1e846099ff13ef6").openStream();
